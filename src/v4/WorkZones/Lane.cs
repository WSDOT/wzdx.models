...
namespace Wsdot.Wzdx.v4.WorkZones
{
    ...
    {
        /// <summary>
        /// The position (index) of the lane in sequence on the roadway, where '1' represents the left-most lane
        /// </summary>
        ...
        /// <summary>
        /// ***DEPRECATED*** The number assigned to the lane to help identify its position. Flexible, but usually used for regular, driveable lanes
        /// </summary>
