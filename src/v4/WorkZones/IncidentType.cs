...
namespace Wzdx.v4.WorkZones
{
    ...
    {
        [Category(nameof(IncidentCategory.Crash))]
        [EnumMember(Value = "crash")]  // A crash interrupts normal operations.
        Crash,
        [Category(nameof(IncidentCategory.Crash))]
        [EnumMember(Value = "injury")] // A crash involving and injury interrupts normal operations.
        Injury,
        [Category(nameof(IncidentCategory.Crash))]
        [EnumMember(Value = "investigation")]
        [Description("A crash investigation interrupts normal operations.")]
        Investigation,
        [Category(nameof(IncidentCategory.Crash))] 
        [EnumMember(Value = "incident")] // A non-crash incident interrupts normal operations.
        Incident, 
        [Category(nameof(IncidentCategory.Crash))]
        [EnumMember(Value = "spill")]
